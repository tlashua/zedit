...
"""
    ...
    private fun formatMultilineString(text: String): String {
        // If the text contains newlines, use TOML triple quotes
    ...
    fun loadZone(file: File): Zone {
        ...
        try {
            ...
            log.error("Failed to parse zone file", e)
            throw e
        }
    }
}